...
#define test_object_bg_bn_gfxTilesLen 1472
extern const bn::tile test_object_bg_bn_gfxTiles[46];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_object_bg(
            regular_bg_tiles_item(span<const tile>(test_object_bg_bn_gfxTiles, 46), bpp_mode::BPP_8, compression_type::NONE), 
