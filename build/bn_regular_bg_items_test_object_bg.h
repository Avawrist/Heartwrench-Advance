...
//	Total size: 32 + 1344 + 1638400 = 1639776
//
...
#define test_object_bg_bn_gfxTilesLen 1344
extern const bn::tile test_object_bg_bn_gfxTiles[42];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_object_bg(
            regular_bg_tiles_item(span<const tile>(test_object_bg_bn_gfxTiles, 42), bpp_mode::BPP_8, compression_type::NONE), 
