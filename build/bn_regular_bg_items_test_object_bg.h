...
//	+ 22 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 1408 + 1638400 = 1639840
//
//	Time-stamp: 2025-07-17, 16:22:15
...
#define test_object_bg_bn_gfxTilesLen 1408
extern const bn::tile test_object_bg_bn_gfxTiles[44];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_object_bg(
            regular_bg_tiles_item(span<const tile>(test_object_bg_bn_gfxTiles, 44), bpp_mode::BPP_8, compression_type::NONE), 
