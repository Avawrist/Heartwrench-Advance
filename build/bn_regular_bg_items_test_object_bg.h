...
//	+ 20 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 1280 + 1638400 = 1639712
//
//	Time-stamp: 2025-07-13, 13:45:31
...
#define test_object_bg_bn_gfxTilesLen 1280
extern const bn::tile test_object_bg_bn_gfxTiles[40];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_object_bg(
            regular_bg_tiles_item(span<const tile>(test_object_bg_bn_gfxTiles, 40), bpp_mode::BPP_8, compression_type::NONE), 
