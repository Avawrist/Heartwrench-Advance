...
//======================================================================
//
//	scythe_platform_bn_gfx, 32x32@4, 
...
#define scythe_platform_bn_gfxTilesLen 512
extern const bn::tile scythe_platform_bn_gfxTiles[16];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item scythe_platform(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(scythe_platform_bn_gfxTiles, 16), bpp_mode::BPP_4, compression_type::NONE, 1), 
            sprite_palette_item(span<const color>(scythe_platform_bn_gfxPal, 16), bpp_mode::BPP_4, compression_type::NONE));
}
