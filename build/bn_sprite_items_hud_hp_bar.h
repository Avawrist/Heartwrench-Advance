...
//======================================================================
//
//	hud_hp_bar_bn_gfx, 64x320@4, 
//	+ palette 16 entries, not compressed
//	+ 320 tiles not compressed
//	Total size: 32 + 10240 = 10272
//
//	Time-stamp: 2025-07-08, 16:33:07
...
#define hud_hp_bar_bn_gfxTilesLen 10240
extern const bn::tile hud_hp_bar_bn_gfxTiles[320];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item hud_hp_bar(sprite_shape_size(sprite_shape::SQUARE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(hud_hp_bar_bn_gfxTiles, 320), bpp_mode::BPP_4, compression_type::NONE, 5), 
