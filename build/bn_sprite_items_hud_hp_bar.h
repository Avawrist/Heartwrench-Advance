...
#define hud_hp_bar_bn_gfxTilesLen 14336
extern const bn::tile hud_hp_bar_bn_gfxTiles[448];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item hud_hp_bar(sprite_shape_size(sprite_shape::SQUARE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(hud_hp_bar_bn_gfxTiles, 448), bpp_mode::BPP_4, compression_type::NONE, 7), 
