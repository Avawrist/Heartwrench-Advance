...
//	+ 92 tiles (t|f reduced) not compressed
//	+ regular map (flat), not compressed, 160x96 
//	Total size: 128 + 5888 + 30720 = 36736
//
//	Time-stamp: 2025-07-22, 15:53:37
...
#define ziggurat_1_painted_bg_bn_gfxTilesLen 5888
extern const bn::tile ziggurat_1_painted_bg_bn_gfxTiles[184];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item ziggurat_1_painted_bg(
            regular_bg_tiles_item(span<const tile>(ziggurat_1_painted_bg_bn_gfxTiles, 184), bpp_mode::BPP_8, compression_type::NONE), 
