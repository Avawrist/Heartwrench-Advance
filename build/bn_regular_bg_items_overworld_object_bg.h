...
#define overworld_object_bg_bn_gfxMapLen 8192
extern const bn::regular_bg_map_cell overworld_object_bg_bn_gfxMap[4096];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item overworld_object_bg(
            ...
            regular_bg_map_item(overworld_object_bg_bn_gfxMap[0], size(64, 64), compression_type::NONE, 1, false));
}
