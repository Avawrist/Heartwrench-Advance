...
//======================================================================
//
//	player_bn_gfx, 64x4224@4, 
//	+ palette 16 entries, not compressed
//	+ 4224 tiles not compressed
//	Total size: 32 + 135168 = 135200
//
//	Time-stamp: 2025-06-10, 00:03:31
...
#define player_bn_gfxTilesLen 135168
extern const bn::tile player_bn_gfxTiles[4224];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item player(sprite_shape_size(sprite_shape::SQUARE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(player_bn_gfxTiles, 4224), bpp_mode::BPP_4, compression_type::NONE, 66), 
