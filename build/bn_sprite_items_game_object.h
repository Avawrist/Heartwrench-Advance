...
//	Total size: 32 + 64 = 96
//
//	Time-stamp: 2025-03-01, 16:55:32
...
#define game_object_bn_gfxTilesLen 64
extern const bn::tile game_object_bn_gfxTiles[2];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item game_object(sprite_shape_size(sprite_shape::SQUARE, sprite_size::SMALL), 
            sprite_tiles_item(span<const tile>(game_object_bn_gfxTiles, 2), bpp_mode::BPP_8, compression_type::NONE, 1), 
            sprite_palette_item(span<const color>(game_object_bn_gfxPal, 16), bpp_mode::BPP_8, compression_type::NONE));
}
