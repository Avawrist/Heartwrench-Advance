...
//
//	Time-stamp: 2025-09-03, 14:40:46
...
#define ziggurat_1_object_bg_bn_gfxTilesLen 2112
extern const bn::tile ziggurat_1_object_bg_bn_gfxTiles[66];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item ziggurat_1_object_bg(
            regular_bg_tiles_item(span<const tile>(ziggurat_1_object_bg_bn_gfxTiles, 66), bpp_mode::BPP_8, compression_type::NONE), 
