...
//	+ 178 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 160 + 11392 + 1638400 = 1649952
//
...
#define test_bg_bn_gfxTilesLen 11392
extern const bn::tile test_bg_bn_gfxTiles[356];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_bg(
            regular_bg_tiles_item(span<const tile>(test_bg_bn_gfxTiles, 356), bpp_mode::BPP_8, compression_type::NONE), 
