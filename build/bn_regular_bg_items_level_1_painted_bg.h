...
#define level_1_painted_bg_bn_gfxTilesLen 3744
extern const bn::tile level_1_painted_bg_bn_gfxTiles[117];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item level_1_painted_bg(
            regular_bg_tiles_item(span<const tile>(level_1_painted_bg_bn_gfxTiles, 117), bpp_mode::BPP_4, compression_type::NONE), 
