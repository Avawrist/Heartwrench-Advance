...
//======================================================================
//
//	smash_block_ziggurat_l_bn_gfx, 32x32@4, 
...
#define smash_block_ziggurat_l_bn_gfxTilesLen 512
extern const bn::tile smash_block_ziggurat_l_bn_gfxTiles[16];
...
{
    constexpr inline sprite_item smash_block_ziggurat_l(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(smash_block_ziggurat_l_bn_gfxTiles, 16), bpp_mode::BPP_4, compression_type::NONE, 1), 
