...
//======================================================================
//
//	smash_block_ziggurat_l_bn_gfx, 64x64@4, 
...
#define smash_block_ziggurat_l_bn_gfxTilesLen 2048
extern const bn::tile smash_block_ziggurat_l_bn_gfxTiles[64];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item smash_block_ziggurat_l(sprite_shape_size(sprite_shape::SQUARE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(smash_block_ziggurat_l_bn_gfxTiles, 64), bpp_mode::BPP_4, compression_type::NONE, 1), 
