...
//	+ 33 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 640x320 
//	Total size: 32 + 2112 + 409600 = 411744
//
...
#define troll_tolls_object_bg_bn_gfxTilesLen 2112
extern const bn::tile troll_tolls_object_bg_bn_gfxTiles[66];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item troll_tolls_object_bg(
            regular_bg_tiles_item(span<const tile>(troll_tolls_object_bg_bn_gfxTiles, 66), bpp_mode::BPP_8, compression_type::NONE), 
