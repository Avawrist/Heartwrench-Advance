...
#define wall_right_ghoul_bn_gfxTilesLen 128
extern const bn::tile wall_right_ghoul_bn_gfxTiles[4];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item wall_right_ghoul(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(wall_right_ghoul_bn_gfxTiles, 4), bpp_mode::BPP_4, compression_type::NONE, 1), 
