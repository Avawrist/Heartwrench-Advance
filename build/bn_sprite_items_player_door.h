...
//======================================================================
//
//	player_door_bn_gfx, 64x256@4, 
//	+ palette 16 entries, not compressed
//	+ 256 tiles not compressed
//	Total size: 32 + 8192 = 8224
//
//	Time-stamp: 2025-10-04, 03:00:15
...
#define player_door_bn_gfxTilesLen 8192
extern const bn::tile player_door_bn_gfxTiles[256];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item player_door(sprite_shape_size(sprite_shape::SQUARE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(player_door_bn_gfxTiles, 256), bpp_mode::BPP_4, compression_type::NONE, 4), 
