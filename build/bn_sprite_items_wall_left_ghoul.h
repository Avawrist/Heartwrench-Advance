...
//======================================================================
//
//	wall_left_ghoul_bn_gfx, 32x608@4, 
...
#define wall_left_ghoul_bn_gfxTilesLen 9728
extern const bn::tile wall_left_ghoul_bn_gfxTiles[304];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item wall_left_ghoul(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(wall_left_ghoul_bn_gfxTiles, 304), bpp_mode::BPP_4, compression_type::NONE, 19), 
