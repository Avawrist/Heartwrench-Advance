...
#define wall_left_ghoul_bn_gfxTilesLen 256
extern const bn::tile wall_left_ghoul_bn_gfxTiles[8];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item wall_left_ghoul(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(wall_left_ghoul_bn_gfxTiles, 8), bpp_mode::BPP_8, compression_type::NONE, 1), 
            sprite_palette_item(span<const color>(wall_left_ghoul_bn_gfxPal, 16), bpp_mode::BPP_8, compression_type::NONE));
}
