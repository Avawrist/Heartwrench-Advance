...
#define phase_orb_up_bn_gfxTilesLen 256
extern const bn::tile phase_orb_up_bn_gfxTiles[8];
...
{
    constexpr inline sprite_item phase_orb_up(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(phase_orb_up_bn_gfxTiles, 8), bpp_mode::BPP_8, compression_type::NONE, 1), 
