...
#define phase_orb_up_bn_gfxTilesLen 512
extern const bn::tile phase_orb_up_bn_gfxTiles[16];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item phase_orb_up(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(phase_orb_up_bn_gfxTiles, 16), bpp_mode::BPP_4, compression_type::NONE, 1), 
            sprite_palette_item(span<const color>(phase_orb_up_bn_gfxPal, 16), bpp_mode::BPP_4, compression_type::NONE));
}
