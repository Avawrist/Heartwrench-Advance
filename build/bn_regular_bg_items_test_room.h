...
//======================================================================
//
//	test_room_bn_gfx, 10240x5120@8, 
//	+ palette 64 entries, not compressed
//	+ 9 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 128 + 576 + 1638400 = 1639104
//
//	Time-stamp: 2024-12-30, 18:00:03
...
#define test_room_bn_gfxTilesLen 576
extern const bn::tile test_room_bn_gfxTiles[18];

#define test_room_bn_gfxMapLen 1638400
extern const bn::regular_bg_map_cell test_room_bn_gfxMap[819200];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_room(
            regular_bg_tiles_item(span<const tile>(test_room_bn_gfxTiles, 18), bpp_mode::BPP_8, compression_type::NONE), 
            bg_palette_item(span<const color>(test_room_bn_gfxPal, 64), bpp_mode::BPP_8, compression_type::NONE),
            regular_bg_map_item(test_room_bn_gfxMap[0], size(1280, 640), compression_type::NONE, 1, true));
}
