...
//	+ 260 tiles (t|p reduced) not compressed
//	+ regular map (flat), not compressed, 640x320 
//	Total size: 32 + 8320 + 409600 = 417952
//
//	Time-stamp: 2025-08-19, 15:11:56
...
#define ziggurat_1_level_bg_bn_gfxTilesLen 8320
extern const bn::tile ziggurat_1_level_bg_bn_gfxTiles[260];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item ziggurat_1_level_bg(
            regular_bg_tiles_item(span<const tile>(ziggurat_1_level_bg_bn_gfxTiles, 260), bpp_mode::BPP_4, compression_type::NONE), 
