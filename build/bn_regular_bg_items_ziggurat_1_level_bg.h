...
//	+ 240 tiles (t|p reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 7680 + 1638400 = 1646112
//
//	Time-stamp: 2025-08-02, 15:23:23
...
#define ziggurat_1_level_bg_bn_gfxTilesLen 7680
extern const bn::tile ziggurat_1_level_bg_bn_gfxTiles[240];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item ziggurat_1_level_bg(
            regular_bg_tiles_item(span<const tile>(ziggurat_1_level_bg_bn_gfxTiles, 240), bpp_mode::BPP_4, compression_type::NONE), 
