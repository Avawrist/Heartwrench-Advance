...
//	Total size: 128 + 1344 + 1638400 = 1639872
//
//	Time-stamp: 2025-03-18, 14:55:56
...
#define test_level_bn_gfxTilesLen 1344
extern const bn::tile test_level_bn_gfxTiles[42];

#define test_level_bn_gfxMapLen 1638400
extern const bn::regular_bg_map_cell test_level_bn_gfxMap[819200];

#define test_level_bn_gfxPalLen 128
extern const bn::color test_level_bn_gfxPal[64];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 42), bpp_mode::BPP_8, compression_type::NONE), 
            bg_palette_item(span<const color>(test_level_bn_gfxPal, 64), bpp_mode::BPP_8, compression_type::NONE),
