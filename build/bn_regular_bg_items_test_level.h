...
//	+ 185 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 160 + 11840 + 1638400 = 1650400
//
//	Time-stamp: 2025-04-06, 13:40:26
...
#define test_level_bn_gfxTilesLen 11840
extern const bn::tile test_level_bn_gfxTiles[370];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 370), bpp_mode::BPP_8, compression_type::NONE), 
