...
//	+ 249 tiles (t|p reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 7968 + 1638400 = 1646400
//
//	Time-stamp: 2025-06-22, 15:09:41
...
#define test_level_bn_gfxTilesLen 7968
extern const bn::tile test_level_bn_gfxTiles[249];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 249), bpp_mode::BPP_4, compression_type::NONE), 
