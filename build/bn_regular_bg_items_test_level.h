...
//
//	Time-stamp: 2025-01-01, 12:05:10
...
#define test_level_bn_gfxTilesLen 576
extern const bn::tile test_level_bn_gfxTiles[18];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 18), bpp_mode::BPP_8, compression_type::NONE), 
