...
//	+ 227 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 160 + 14528 + 1638400 = 1653088
//
...
#define test_level_bn_gfxTilesLen 14528
extern const bn::tile test_level_bn_gfxTiles[454];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 454), bpp_mode::BPP_8, compression_type::NONE), 
