...
//	+ 187 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 160 + 11968 + 1638400 = 1650528
//
//	Time-stamp: 2025-05-19, 09:29:22
...
#define test_level_bn_gfxTilesLen 11968
extern const bn::tile test_level_bn_gfxTiles[374];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 374), bpp_mode::BPP_8, compression_type::NONE), 
