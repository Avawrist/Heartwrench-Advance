...
//	+ 189 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 160 + 12096 + 1638400 = 1650656
//
//	Time-stamp: 2025-04-06, 16:24:46
...
#define test_level_bn_gfxTilesLen 12096
extern const bn::tile test_level_bn_gfxTiles[378];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 378), bpp_mode::BPP_8, compression_type::NONE), 
