...
//	Total size: 32 + 6144 + 1638400 = 1644576
//
...
#define test_level_bn_gfxTilesLen 6144
extern const bn::tile test_level_bn_gfxTiles[192];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_level(
            regular_bg_tiles_item(span<const tile>(test_level_bn_gfxTiles, 192), bpp_mode::BPP_4, compression_type::NONE), 
