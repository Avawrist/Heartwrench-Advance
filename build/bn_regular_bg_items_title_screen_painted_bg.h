...
#define title_screen_painted_bg_bn_gfxTilesLen 2944
extern const bn::tile title_screen_painted_bg_bn_gfxTiles[92];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item title_screen_painted_bg(
            regular_bg_tiles_item(span<const tile>(title_screen_painted_bg_bn_gfxTiles, 92), bpp_mode::BPP_4, compression_type::NONE), 
