...
//	+ 633 tiles (t|p reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 20256 + 1638400 = 1658688
//
//	Time-stamp: 2025-05-18, 13:29:49
...
#define test_painted_bg_bn_gfxTilesLen 20256
extern const bn::tile test_painted_bg_bn_gfxTiles[633];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_painted_bg(
            regular_bg_tiles_item(span<const tile>(test_painted_bg_bn_gfxTiles, 633), bpp_mode::BPP_4, compression_type::NONE), 
