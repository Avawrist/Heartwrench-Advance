...
//
//	Time-stamp: 2025-07-17, 15:52:43
...
#define test_painted_bg_bn_gfxTilesLen 4224
extern const bn::tile test_painted_bg_bn_gfxTiles[132];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_painted_bg(
            regular_bg_tiles_item(span<const tile>(test_painted_bg_bn_gfxTiles, 132), bpp_mode::BPP_8, compression_type::NONE), 
