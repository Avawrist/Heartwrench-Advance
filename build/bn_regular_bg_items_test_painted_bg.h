...
//	+ 341 tiles (t|p reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 10912 + 1638400 = 1649344
//
//	Time-stamp: 2025-05-19, 15:51:17
...
#define test_painted_bg_bn_gfxTilesLen 10912
extern const bn::tile test_painted_bg_bn_gfxTiles[341];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_painted_bg(
            regular_bg_tiles_item(span<const tile>(test_painted_bg_bn_gfxTiles, 341), bpp_mode::BPP_4, compression_type::NONE), 
