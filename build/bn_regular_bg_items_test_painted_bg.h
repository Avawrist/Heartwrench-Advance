...
//	Total size: 96 + 128 + 16384 = 16608
//
//	Time-stamp: 2025-04-07, 14:50:37
...
#define test_painted_bg_bn_gfxTilesLen 128
extern const bn::tile test_painted_bg_bn_gfxTiles[4];

#define test_painted_bg_bn_gfxMapLen 16384
extern const bn::regular_bg_map_cell test_painted_bg_bn_gfxMap[8192];

#define test_painted_bg_bn_gfxPalLen 96
extern const bn::color test_painted_bg_bn_gfxPal[48];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_painted_bg(
            regular_bg_tiles_item(span<const tile>(test_painted_bg_bn_gfxTiles, 4), bpp_mode::BPP_8, compression_type::NONE), 
            bg_palette_item(span<const color>(test_painted_bg_bn_gfxPal, 48), bpp_mode::BPP_8, compression_type::NONE),
