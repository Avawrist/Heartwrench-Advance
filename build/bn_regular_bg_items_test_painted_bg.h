...
//	+ 176 tiles (t|p reduced) not compressed
//	+ regular map (flat), not compressed, 1280x640 
//	Total size: 32 + 5632 + 1638400 = 1644064
//
//	Time-stamp: 2025-06-14, 16:02:05
...
#define test_painted_bg_bn_gfxTilesLen 5632
extern const bn::tile test_painted_bg_bn_gfxTiles[176];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item test_painted_bg(
            regular_bg_tiles_item(span<const tile>(test_painted_bg_bn_gfxTiles, 176), bpp_mode::BPP_4, compression_type::NONE), 
