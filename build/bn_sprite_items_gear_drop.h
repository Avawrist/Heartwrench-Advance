...
//======================================================================
//
//	gear_drop_bn_gfx, 32x288@4, 
//	+ palette 16 entries, not compressed
//	+ 144 tiles not compressed
//	Total size: 32 + 4608 = 4640
//
//	Time-stamp: 2025-09-16, 00:19:10
...
#define gear_drop_bn_gfxTilesLen 4608
extern const bn::tile gear_drop_bn_gfxTiles[144];
...
{
    constexpr inline sprite_item gear_drop(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(gear_drop_bn_gfxTiles, 144), bpp_mode::BPP_4, compression_type::NONE, 9), 
