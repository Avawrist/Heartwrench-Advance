...
#define overworld_painted_bg_bn_gfxMapLen 32768
extern const bn::regular_bg_map_cell overworld_painted_bg_bn_gfxMap[16384];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item overworld_painted_bg(
            ...
            regular_bg_map_item(overworld_painted_bg_bn_gfxMap[0], size(128, 128), compression_type::NONE, 1, true));
}
