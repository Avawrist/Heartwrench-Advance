...
//	+ 142 tiles (t reduced) not compressed
//	+ regular map (flat), not compressed, 128x384 
//	Total size: 160 + 9088 + 98304 = 107552
//
//	Time-stamp: 2026-06-04, 17:50:55
...
#define overworld_level_bg_bn_gfxTilesLen 9088
extern const bn::tile overworld_level_bg_bn_gfxTiles[284];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item overworld_level_bg(
            regular_bg_tiles_item(span<const tile>(overworld_level_bg_bn_gfxTiles, 284), bpp_mode::BPP_8, compression_type::NONE), 
