...
#define phase_orb_left_bn_gfxTilesLen 1024
extern const bn::tile phase_orb_left_bn_gfxTiles[32];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item phase_orb_left(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(phase_orb_left_bn_gfxTiles, 32), bpp_mode::BPP_8, compression_type::NONE, 1), 
