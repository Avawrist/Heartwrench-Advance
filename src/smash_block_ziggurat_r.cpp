...
void SmashBlockZigguratR::updateDeathState()
{
    if(animate_action_ptr->current_index() == SMASH_BLOCK_ZIGGURAT_R_HIT_STOP_TRIGGER_FRAME)
    {global_hitstop_frames = SMASH_BLOCK_ZIGGURAT_R_HIT_STOP_FRAMES;}
