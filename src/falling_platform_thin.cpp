...
void FallingPlatformThin::resolvePushBlockCollision(GameObject& object)
{
...
void FallingPlatformThin::resolvePushBlockMiniCollision(GameObject& object)
{
    Collider roof_test_collider = Collider(collider.x(),
                                           collider.y() + FALLING_PLATFORM_THIN_ROOF_OFFSET,
                                           collider.width,
...
void FallingPlatformThin::resolveGroundGhoulCollision(GameObject& object)
{
    Collider roof_test_collider = Collider(collider.x(),
                                           collider.y() + FALLING_PLATFORM_THIN_ROOF_OFFSET,
                                           collider.width,
