...
#define GENERIC_HIT_Y_KNOCKBACK        -3
#define GENERIC_HIT_KNOCKBACK_DECAY    0.05
#define GENERIC_HIT_DAMAGE             10
#define GENERIC_HIT_HITSTOP_FRAMES     0
#define GENERIC_HIT_HITSTUN_FRAMES     15
...
enum ObjectState
{
	...
	// Sub Area Gate
	SUB_AREA_GATE_OPEN_1,
	SUB_AREA_GATE_OPEN_2,
	SUB_AREA_GATE_OPEN_3,
...
struct GameObject 
{
	...
	virtual void applyDamage(int32 _damage);
