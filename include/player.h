...
#define PLAYER_SCYTHE_GROUND_1_HB_LIFESPAN_FRAMES GAME_OBJECT_HIT_INVULNERABILITY_FRAMES + 1
#define PLAYER_SCYTHE_GROUND_1_X_KNOCKBACK        8
#define PLAYER_SCYTHE_GROUND_1_Y_KNOCKBACK        0
#define PLAYER_SCYTHE_GROUND_1_KNOCKBACK_DECAY    0.05
#define PLAYER_SCYTHE_GROUND_1_DAMAGE             1
#define PLAYER_SCYTHE_GROUND_1_HITSTOP_FRAMES     8
#define PLAYER_SCYTHE_GROUND_1_HITSTUN_FRAMES     30
#define PLAYER_SCYTHE_GROUND_1_SCREENSHAKE_FRAMES 8
#define PLAYER_SCYTHE_GROUND_1_SCREENSHAKE_SEVERITY STRONG_SHAKE
...
#define PLAYER_SCYTHE_AIR_1_HB_LIFESPAN_FRAMES GAME_OBJECT_HIT_INVULNERABILITY_FRAMES + 1
#define PLAYER_SCYTHE_AIR_1_X_KNOCKBACK        8
#define PLAYER_SCYTHE_AIR_1_Y_KNOCKBACK        0
#define PLAYER_SCYTHE_AIR_1_KNOCKBACK_DECAY    0.05
#define PLAYER_SCYTHE_AIR_1_DAMAGE             1
#define PLAYER_SCYTHE_AIR_1_HITSTOP_FRAMES     8
#define PLAYER_SCYTHE_AIR_1_HITSTUN_FRAMES     30
#define PLAYER_SCYTHE_AIR_1_SCREENSHAKE_FRAMES 8
#define PLAYER_SCYTHE_AIR_1_SCREENSHAKE_SEVERITY STRONG_SHAKE
