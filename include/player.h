...
#define PLAYER_MAX_JUMP_INPUT_FRAMES       0
...
#define PLAYER_SCYTHE_GROUND_1_X_KNOCKBACK        12
#define PLAYER_SCYTHE_GROUND_1_Y_KNOCKBACK        3
