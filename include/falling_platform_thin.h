...
#define FALLING_PLATFORM_THIN_ROOF_OFFSET          -8
#define FALLING_PLATFORM_THIN_ROOF_COLLIDER_HEIGHT 16

#define FALLING_PLATFORM_THIN_HITPOINTS 1

#define FALLING_PLATFORM_THIN_30_FPS false

#define FALLING_PLATFORM_THIN_FALL_TIMER    15
#define FALLING_PLATFORM_THIN_SPEEDUP_TIMER 30

#define FALLING_PLATFORM_THIN_FALL_SPEED     1
