...
#define SKULL_DROP_COLLIDER_HEIGHT 14
...
#define SKULL_DROP_30_FPS true

#define SKULL_DROP_VALUE 3

#define SKULL_DROP_STARTING_INVULN_FRAMES 8

#define SKULL_DROP_SPAWN_Y_FORCE    -8
#define SKULL_DROP_SPAWN_FORCE_DECAY 0.2
